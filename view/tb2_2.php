...
function addFOI()
  { 
    ...
    /*
    if(confirm("Vous allez visualiser les zones explorées par d'autres utilisateurs pour cette requête")){
      read_recommendation ();
    }*/
   } 
...
<div id="div_parent">
     <div class="child" id="areachart" style="background-color: white; border: 1px solid #ccc;box-shadow: 0px 0px 3px #ccc">
      ...
      <input id="check" TYPE="checkbox" onclick="createToolBar(this)" >toolbar
      <label id="Labcheck" ></label>
      <div  id="sugmap" class="child" style="width: 300px;height: 200px;">
        </div>
     </div>
